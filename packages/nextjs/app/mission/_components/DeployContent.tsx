    ...
    <>
      ...
      <div className="flex justify-center top">
        <p className="text-lg text-center max-w-2xl">
          Up to this point we have been doing local first development. In this part of the mission you will deploy your
          smart contract to a public network. This way we can index the data on The Graph's decentralized network.
        </p>
      </div>
