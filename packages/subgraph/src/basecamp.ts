import {
  ...
  CredentialSet as CredentialSetEvent,
...
} from "../generated/Basecamp/Basecamp"
import {
  AdminAdded,
  AdminRemoved,
  ApprovalForAll,
...
export function handleCredentialMinted(event: CredentialMintedEvent): void {
  ...
  entity.Basecamp_id = event.params.id
...
export function handleCredentialSet(event: CredentialSetEvent): void {
  let entity = new CredentialSet(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
